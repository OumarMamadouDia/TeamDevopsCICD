...
@ManagedBean(name = "EnterOrderView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "EnterOrderView", beanType = BeanType.PORTLET)
public class EnterOrderView  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
