...
@ManagedBean(name = "CheckOrderView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "CheckOrderView", beanType = BeanType.PORTLET)
public class CheckOrderView  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
