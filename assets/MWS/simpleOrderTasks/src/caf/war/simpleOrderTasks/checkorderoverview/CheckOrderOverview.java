...
@ManagedBean(name = "CheckOrderOverview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "CheckOrderOverview", beanType = BeanType.PORTLET)
public class CheckOrderOverview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
