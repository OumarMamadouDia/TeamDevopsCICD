...
@ManagedBean(name = "EnterOrderOverview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "EnterOrderOverview", beanType = BeanType.PORTLET)
public class EnterOrderOverview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {

	private transient caf.war.simpleOrderTasks.SimpleOrderTasks simpleOrderTasks = null;
	/**
	...
	public caf.war.simpleOrderTasks.SimpleOrderTasks getSimpleOrderTasks()  {
		if (simpleOrderTasks == null) {
		    simpleOrderTasks = (caf.war.simpleOrderTasks.SimpleOrderTasks)resolveExpression("#{SimpleOrderTasks}");
		}
		return simpleOrderTasks;
	}
